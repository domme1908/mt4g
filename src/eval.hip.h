...
{
#ifdef IsDebug
    fprintf(out, "Creating set of existing values in sample...");
    fflush(stdout);
#endif // IsDebug
...
#ifdef IsDebug
    fprintf(out, "DONE\n");
    fprintf(out, "Create two samples for test execution...");
    fflush(stdout);
#endif // IsDebug
